...
import ferramentas.TabelaClasseProduto;
 ...
 * @author user
 */
public class FormCadClasseProduto extends javax.swing.JFrame {
    TabelaClasseProduto model ;
    List<ClasseProduto> listClasseProduto;
    ClasseProdutoBD bd  = new ClasseProdutoBD();
    /**
     * Creates new form FormCadClasseProdutos
     */
    public FormCadClasseProduto() {
        initComponents();
        preencheTabela();
...
public final void preencheTabela(){
    try {
            listClasseProduto= bd.GetListaClasseProduto();
            model = new TabelaClasseProduto(listClasseProduto);
            tabelaClasseProduto.setModel(model);
        } catch (Exception ex) {
            Logger.getLogger(FormCadClasseProduto.class.getName()).log(Level.SEVERE, null, ex);
        }
}
    /**
    ...
    private void initComponents() {
        ...
        tabelaClasseProduto = new javax.swing.JTable();
        ...
        tabelaClasseProduto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tabelaClasseProduto);
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
       ClasseProduto marca = preencheClasseProduto();
       if(edtCodigo.getText().isEmpty()){
           try {
               bd.adicionarClasseProduto(marca);
           ...
           try {
               bd.AtualizaClasseProduto(marca);
...
// TODO add your handling code here:
 ...
 public void alterar(){
      ...
      ClasseProduto cliente;
        linhaSelecionada = tabelaClasseProduto.getSelectedRow();
        if (linhaSelecionada >= 0) { 
            int idCliente = (int) tabelaClasseProduto.getValueAt(linhaSelecionada, 0);
          
           
            cliente=bd.getClasseProdutoById(idCliente);
    ...
    public void excluir(){
        ...
        if (linhaSelecionada >= 0) { 
           ...
           bd.removerClasseProduto(idCliente);
            preencheTabela();
    ...
    public ClasseProduto preencheClasseProduto(){
    ClasseProduto marca = new ClasseProduto();
    if(edtCodigo.getText().isEmpty()){
        
    }else{
        marca.setId(Integer.valueOf(edtCodigo.getText()));
    }
    marca.setDescricao(edtDescricao.getText());
    return marca;
}
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadClasseProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadClasseProduto().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabelaClasseProduto;
