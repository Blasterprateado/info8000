...
import Conection.ContasReceberBD;
import Objetos.ContasReceber;
import Relatorios.ReportUtilsDireto;
import ferramentas.TabelaContasReceber;
 ...
 * @author USUARIO
 */
public class FormContasReceber extends javax.swing.JFrame {
List<ContasReceber> lista;
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        if (edtDescricao.getText().isEmpty()==false && edtValor.getText().isEmpty()==false) {
            ContasReceber marca = preencheContas();
            ContasReceberBD bd = new ContasReceberBD();
            if (edtCodigo.getText().isEmpty()) {
                try {
                    bd.adicionarContasReceber(marca);
...
private void alterar(){
    ...
    int id;
        ...
        if (linhaSelecionada >= 0) { 
            ...
            conta= bd.getContasReceberById(id);
...
TabelaContasReceber tabela_model = (TabelaContasReceber) tabelaContas.getModel();
...
private void relatorio(int id){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormContasReceber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormContasReceber().setVisible(true);
            }
        });
    }
    ...
    private ContasReceber preencheContas() {
    ...
    private void preencheTabela() {
        ContasReceberBD bd = new ContasReceberBD();
    try {
        lista= bd.getListaContasReceber();
    } catch (Exception ex) {
        Logger.getLogger(FormContasReceber.class.getName()).log(Level.SEVERE, null, ex);
    }
        TabelaContasReceber model = new TabelaContasReceber(lista);
