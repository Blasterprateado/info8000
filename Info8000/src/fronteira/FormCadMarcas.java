...
import ferramentas.TabelaMarcas;
 ...
 * @author user
 */
public class FormCadMarcas extends javax.swing.JFrame {
    TabelaMarcas model ;
    List<Marca> listMarca;
    MarcaBD bd  = new MarcaBD();
    /**
     * Creates new form FormCadMarcas
     */
    public FormCadMarcas() {
        initComponents();
        preencheTabela();
...
public final void preencheTabela(){
    try {
            listMarca= bd.getListaMarca();
            model = new TabelaMarcas(listMarca);
            tabelaMarca.setModel(model);
        } catch (Exception ex) {
            Logger.getLogger(FormCadMarcas.class.getName()).log(Level.SEVERE, null, ex);
        }
}
    /**
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
       Marca marca = preencheMarca();
       if(edtCodigo.getText().isEmpty()){
           try {
               bd.adicionarMarca(marca);
...
// TODO add your handling code here:
 ...
 public void alterar(){
      ...
      Marca cliente;
        linhaSelecionada = tabelaMarca.getSelectedRow();
        if (linhaSelecionada >= 0) { 
            int idCliente = (int) tabelaMarca.getValueAt(linhaSelecionada, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadMarcas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadMarcas().setVisible(true);
            }
        });
    }
