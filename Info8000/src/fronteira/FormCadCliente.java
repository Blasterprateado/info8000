...
public class FormCadCliente extends javax.swing.JFrame {
    ...
    public FormCadCliente() {
       ...
       //AutoCompletion.enable(ComboCidade);
        //AutoCompleteComboBox complete= new AutoCompleteComboBox(ComboCidade);
          AutoCompleteDecorator.decorate(ComboCidade);
    ...
    public FormCadCliente(Cliente cliente) {
     ...
     ComboCidade.setModel(combomodel);
       // AutoCompletion.enable(ComboCidade);
        ...
        edtEnd.setText(cliente.getEndereco());
...
public void preencheTabela(){
    ...
    private void initComponents() {
        ...
        ComboCidade.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
                ComboCidadeCaretPositionChanged(evt);
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                ComboCidadeInputMethodTextChanged(evt);
            }
        });
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
       ...
       if(edtCodigo.getText().isEmpty()){
          if(cliente!=null){
           ...
           JOptionPane.showMessageDialog(this, "Erro no preenchimento, verifique");
       } 
       }else{
           try {
               bd.AtualizaCliente(cliente);
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
       if(btnIncluirStatus==1){
          int resposta= JOptionPane.showConfirmDialog(this, "Você esta no processo de inclusão de cliente, deseja cancelar?","Atenção!",JOptionPane.YES_NO_OPTION);
 ...
 if(btnAlterarStatus==0){//0 indica que nao foi clicado
    ...
    public void alterar(){
        ...
        if (linhaSelecionada >= 0) { 
            ...
            Cidade cidade=null;
            try {
                cidade = bd.getListaCidadeBYID(cliente.getCidade());
            } catch (Exception ex) {
                Logger.getLogger(FormCadCliente.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void ComboCidadeInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_ComboCidadeInputMethodTextChanged
      
    }//GEN-LAST:event_ComboCidadeInputMethodTextChanged

    private void ComboCidadeCaretPositionChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_ComboCidadeCaretPositionChanged
      
    }//GEN-LAST:event_ComboCidadeCaretPositionChanged
    ...
    if(edtCodigo.getText().isEmpty()){
        ...
        cliente.setId(Integer.valueOf(edtCodigo.getText()));
    }
    ...
    cliente.setEndereco(edtEnd.getText());
            cliente.setNumero(Integer.valueOf(edtNumero.getText()));
              cliente.setTelefone(edtTel.getText());
    Cidade cidade = (Cidade) ComboCidade.getSelectedItem();
        System.out.println(cidade);
    cliente.setCidade(cidade.getId());
     
        } catch (NumberFormatException numberFormatException) {
            JOptionPane.showMessageDialog(this, "Você inseriu letras no lugar de números, revise!!");
