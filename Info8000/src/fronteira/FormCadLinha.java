...
import ferramentas.TabelaProdutoLinha;
 ...
 * @author user
 */
public class FormCadLinha extends javax.swing.JFrame {
    TabelaProdutoLinha model ;
    List<ProdutoLinha> listLinha;
    LinhaBD bd  = new LinhaBD();
    /**
     * Creates new form FormCadLinhas
     */
    public FormCadLinha() {
        initComponents();
        preencheTabela();
...
public final void preencheTabela(){
    try {
            listLinha= bd.getListaProdutoLinha();
            model = new TabelaProdutoLinha(listLinha);
            tabelaLinha.setModel(model);
        } catch (Exception ex) {
            Logger.getLogger(FormCadLinha.class.getName()).log(Level.SEVERE, null, ex);
        }
}
    /**
    ...
    private void initComponents() {
        ...
        tabelaLinha = new javax.swing.JTable();
        ...
        tabelaLinha.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tabelaLinha);
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
       ProdutoLinha marca = preencheLinha();
       if(edtCodigo.getText().isEmpty()){
           try {
               bd.adicionarProdutoLinha(marca);
...
// TODO add your handling code here:
 ...
 public void alterar(){
      ...
      ProdutoLinha cliente;
        linhaSelecionada = tabelaLinha.getSelectedRow();
        if (linhaSelecionada >= 0) { 
            int idCliente = (int) tabelaLinha.getValueAt(linhaSelecionada, 0);
    ...
    public void excluir(){
        ...
        linhaSelecionada = tabelaLinha.getSelectedRow();
        if (linhaSelecionada >= 0) { 
            int idLinha = (int) tabelaLinha.getValueAt(linhaSelecionada, 0);
          
           
           bd.removerProdutoLinha(idLinha);
            preencheTabela();
    ...
    public ProdutoLinha preencheLinha(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadLinha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadLinha().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabelaLinha;
