...
import ferramentas.TabelaProdutoUnd;
 ...
 * @author user
 */
public class FormCadUndComercial extends javax.swing.JFrame {
    TabelaProdutoUnd model ;
    List<Unidadecomercial> listUnidadecomercial;
    UnidadeComercialBD bd  = new UnidadeComercialBD();
    /**
     * Creates new form FormCadUnidadecomercials
     */
    public FormCadUndComercial() {
        initComponents();
        preencheTabela();
...
public final void preencheTabela(){
    try {
            listUnidadecomercial= bd.getListaUnidadecomercial();
            model = new TabelaProdutoUnd(listUnidadecomercial);
            tabelaUnd.setModel(model);
        } catch (Exception ex) {
            Logger.getLogger(FormCadUndComercial.class.getName()).log(Level.SEVERE, null, ex);
        }
}
    /**
    ...
    private void initComponents() {
        ...
        tabelaUnd = new javax.swing.JTable();
        ...
        tabelaUnd.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tabelaUnd);
        ...
        panelCadastroLayout.setHorizontalGroup(
            ...
            .addGroup(panelCadastroLayout.createSequentialGroup()
                ...
                .addGroup(panelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(edtValor, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
      Unidadecomercial marca = preencheUnidadecomercial();
       if(edtCodigo.getText().isEmpty()){
           try {
               bd.adicionarUnidadecomercial(marca);
               JOptionPane.showMessageDialog(this,"Sucesso ao adicionar "+ marca.getSigla().toString() + "");
           } catch (Exception ex) {
               Logger.getLogger(FormCadUndComercial.class.getName()).log(Level.SEVERE, null, ex);
           }
       }else{
           try {
               bd.AtualizaUnidadecomercial(marca);
                JOptionPane.showMessageDialog(this,"Sucesso ao atualizar "+ marca.getSigla().toString() + "");
           } catch (Exception ex) {
               Logger.getLogger(FormCadUndComercial.class.getName()).log(Level.SEVERE, null, ex);
           }
       }
...
// TODO add your handling code here:
 ...
 public void alterar(){
      ...
      Unidadecomercial cliente;
        linhaSelecionada = tabelaUnd.getSelectedRow();
        if (linhaSelecionada >= 0) { 
            int idCliente = (int) tabelaUnd.getValueAt(linhaSelecionada, 0);
          
           
            cliente=bd.getEmpresaById(idCliente);
            edtCodigo.setText(String.valueOf(cliente.getIdUnidadeComercial()));
           edtDescricao.setText(cliente.getSigla());
           PanelGuia.setSelectedIndex(1);
           btnIncluir.setEnabled(false);
        btnAlterar.setEnabled(false);
        btnExcluir.setEnabled(false);
    ...
    public void excluir(){
        ...
        linhaSelecionada = tabelaUnd.getSelectedRow();
        if (linhaSelecionada >= 0) { 
            int idUnidadecomercial = (int) tabelaUnd.getValueAt(linhaSelecionada, 0);
          
           
           bd.removerUnidadecomercial(idUnidadecomercial);
            preencheTabela();
    ...
    public Unidadecomercial preencheUnidadecomercial(){
  Unidadecomercial linha = new Unidadecomercial();
    if(edtCodigo.getText().isEmpty()){
        
    }else{
        linha.setIdUnidadeComercial(Integer.valueOf(edtCodigo.getText()));
    }
    linha.setSigla(edtDescricao.getText());
    linha.setValor(Double.valueOf(edtValor.getText()));
    return linha;
}
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadUndComercial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadUndComercial().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabelaUnd;
