 ...
 * @author user
 */
public class TabelaListarProdutos extends AbstractTableModel{
    ...
    List<Produto> linhas;
    private final String[] colunas = new String[]{"CODIGO", "DESCRICAO", "MARCA", "PREÇO DE VENDA","ESTOQUE","FORNECEDOR", "CLASSE"};
    public TabelaListarProdutos(List<Produto> produtos) {
