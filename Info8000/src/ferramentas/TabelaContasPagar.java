 ...
 * @author user
 */
public class TabelaContasPagar extends AbstractTableModel{
...
public void setValueAt(Object aValue, int row, int column) {
    ...
    public ContasPagar getContasPagar(int indiceLinha) {
        return linhas.get(indiceLinha); 
    } 
    public void addContasPagar(ContasPagar classeProduto) {
        linhas.add(classeProduto);
        int ultimoIndice = getRowCount() - 1;
        fireTableRowsInserted(ultimoIndice, ultimoIndice);
    }
    public void updateContasPagar(int indiceLinha, ContasPagar marca) {
        linhas.set(indiceLinha, marca);
        fireTableRowsUpdated(indiceLinha, indiceLinha);
    } public void removeContasPagar(int indiceLinha) {
