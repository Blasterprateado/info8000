...
public class ACBrNFe {
    ...
    public void setModeloDf(String modeloDF) throws ACBrNFeException{
        comandoNFe("SetModeloDF("+modeloDF+")");
    }
    public void setVersaoDf(String versaoDF) throws ACBrNFeException{
        comandoNFe("SetVersaoDF("+versaoDF+")");
    }
    /**
...
//    }
    ...
    public Date getDataVencimentoCertificado() throws ACBrNFeException {
        try {
            ...
            Logger.getLogger(ACBrNFe.class.getName()).log(Level.SEVERE, null, ex);
